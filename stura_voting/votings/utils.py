...
def get_next_semester(reference_date=None):
    ...
    One from October 1 to March 31 and one from April 1 to September 30. It will only compute semester time spans in the
    future. It will return first a string, either 'winter' or 'summer' (which term it is) and two dates (start and end).
    ...
    candidates = [('winter', datetime.date(month=10, day=1, year=reference_date.year), datetime.date(month=3, day=31, year=reference_date.year + 1)),
